...
<?php 
 ...
 ?>
        ...
        <td id="page">
        <fieldset>
            <legend align="center"><h2>Student Addresses</h2></legend>
                <table width="100%">
                    <tr>
                        <td>
                  <form action="address.php?link=staff" method="post" enctype="multipart/form-data">
         <table><tr><td>
		 <select name="dept" >
